                ...
                <div className='seacrhCity w-full flex flex-col gap-2.5 mt-4'>
                    <div className="bg-[#1a1b1a] w-full h-auto rounded-2xl p-2 py- flex flex-col gap-2 text-white/80 border-1 border-white/20">
                        ...
                        <div className="search bg-[#1a1b1a] flex items-center px-4 rounded-[2.5vh] cursor-pointer h-12 w-full border-1 border-white/30">
                            ...
                            <input type="text" placeholder="Search..." className="w-full outline-0" value={search} onChange={(e) => setSearch(e.target.value)} onFocus={() => handleFocus('search')} onBlur={() => handleBlur('search')} />
                        </div>
                        ...
                        <div className="text-[2.1vh] flex gap-2">
                            <div className="Latitude bg-[#1a1b1a] flex items-center px-4 rounded-[2.5vh] cursor-pointer h-12 w-full border-1 border-white/30">
                                ...
                                <input type="tel" placeholder="Latitude" className="w-full outline-0" value={lat} onChange={(e) => setLat(e.target.value)} onFocus={() => handleFocus('lat')} onBlur={() => handleBlur('lat')} />
                            </div>
                            <div className="Longitude bg-[#1a1b1a] flex items-center px-4 rounded-[2.5vh] cursor-pointer h-12 w-full border-1 border-white/30">
                                ...
                                <input type="tel" placeholder="Longitude" className="w-full outline-0" value={lon} onChange={(e) => setLon(e.target.value)} onFocus={() => handleFocus('lon')} onBlur={() => handleBlur('lon')} />
                            </div>
                        </div>
                        ...
                        <div className="city bg-[#1a1b1a] flex items-center px-4 rounded-[2.5vh] cursor-pointer h-12 w-full border-1 border-white/30">
                            ...
                            <input type="text" placeholder="City" className="w-full outline-0" value={city} onChange={(e) => setCity(e.target.value)} onFocus={() => handleFocus('city')} onBlur={() => handleBlur('city')} />
                        </div>
                        ...
                        <div className="district bg-[#1a1b1a] flex items-center px-4 rounded-[2.5vh] cursor-pointer h-12 w-full border-1 border-white/30">
                            ...
                            <input type="text" placeholder="District" className="w-full outline-0" value={district} onChange={(e) => setDistrict(e.target.value)} onFocus={() => handleFocus('district')} onBlur={() => handleBlur('district')} />
                        </div>
